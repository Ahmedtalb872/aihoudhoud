...
///
/// Owned by the active-trip screen for the screen's whole lifetime (not by
/// [CallScreen] itself), so the same subscription keeps listening for the
/// *next* incoming call after one ends - see
/// `CaptainActiveTripScreen`'s `_callSignaling`.
