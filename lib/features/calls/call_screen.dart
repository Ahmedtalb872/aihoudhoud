...
///   caller (see `CaptainActiveTripScreen`'s `_callSignaling.onOffer`
///   listener, which pushes this screen instead of creating one) - shows
///   an accept/decline prompt instead of dialing immediately.
///
/// Owns a [CallService] for the call's duration, but not the
/// [CallSignalingService] itself - that's owned by the active-trip screen
